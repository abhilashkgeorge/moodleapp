...
export class CoreLoginHelperProvider {
    ...
    //             const data = await CoreSites.getUserToken("https://lms.haldiram.com/", "rs2", "Trial@123");
    //             //const canReset = await this.canRequestPasswordReset(siteUrl);
    ...
    //         } catch (error) {
    //             CoreUserSupport.showAlert(
    //                 "An Error Occured on reset password clicked"
    //             )
    ...
    //         } catch (error) {
    //             CoreUserSupport.showAlert(
    //                 "An Error Occured on change password directly"
    //             )
